...
[DOWNLOAD](https://github.com/sheepdog/sheepdog/archive/v0.9.0.tar.gz) latest stable release.  
[Older versions](https://github.com/sheepdog/sheepdog/wiki/Stable-branches#obtain-stable-release-based-on-the-stable-branches) can be found here.  Below is an example of v0.7.6.
